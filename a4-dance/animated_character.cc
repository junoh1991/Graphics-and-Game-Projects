                                          ...
                                          const Matrix4 &view_matrix, const Matrix4 &proj_matrix)
{
    ...
    */
    ...
    if (bone_name == "lowerback") {
		...
		quick_shapes_.DrawSphere(ctm * e, view_matrix, proj_matrix, Color(1, 0, 0));
    }
    ...
    if (bone_name == "head") {
		...
		quick_shapes_.DrawSphere(ctm * head, view_matrix, proj_matrix, Color(1, 0, 0));
		...
		quick_shapes_.DrawCone(ctm * lscape, view_matrix, proj_matrix, Color(0, 0, 0));
		quick_shapes_.DrawCone(ctm * rscape, view_matrix, proj_matrix, Color(0, 0, 0));
    }
