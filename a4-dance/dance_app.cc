...
DanceApp::DanceApp() : GraphicsApp(1280,768, "So You Think Ants Can Dance") {
    ...
    ballet_special4_.TrimFront(600);
    ...
    ballet_special5_.TrimFront(300);
    ballet_special5_.TrimBack(50);
	ballet_special5_.MakeLoop(150);
